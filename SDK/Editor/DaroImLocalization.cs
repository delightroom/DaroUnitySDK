...
namespace Daro.Editor
{
    ...
    internal static class DaroImLocalization
    {
        ...
        private static readonly Dictionary<string, string> _en = new Dictionary<string, string>
        {
            ...
            ["v.any.platformChecks.msg"]  = "Platform checks skipped — active build target is {0}.",
            ["v.any.platformChecks.hint"] = "Switch to Android or iOS in File > Build Settings, then run the checks again.",
        ...
        private static readonly Dictionary<string, string> _ko = new Dictionary<string, string>
        {
            ...
            ["v.any.platformChecks.msg"]  = "플랫폼 검사를 건너뛰었습니다 — 현재 빌드 타겟이 {0}입니다.",
            ["v.any.platformChecks.hint"] = "File > Build Settings에서 Android 또는 iOS로 전환한 뒤 다시 실행하세요.",
